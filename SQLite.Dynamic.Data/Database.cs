...
namespace SQLite.Dynamic.Data
{
    ...
    public class Database
    {
        ...
        /// </code>
        /// </example>
        public object QueryScalar(string query, params object[] parameters)
        {
            object res = null;
            using (SQLiteConnection conn = new SQLiteConnection(this._ConnectionString))
            {
        ...
        /// </code>
        /// </example>
        public dynamic QuerySingle(string query, params object[] parameters)
        {
            dynamic res = null;
            using (SQLiteConnection conn = new SQLiteConnection(this._ConnectionString))
            {
        ...
        /// </code>
        /// </example>
        public dynamic QuerySingle(string query)
        {
